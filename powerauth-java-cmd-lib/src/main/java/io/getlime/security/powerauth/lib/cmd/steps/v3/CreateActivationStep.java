...
public class CreateActivationStep implements BaseStep {
    ...
    public ResultStatusObject execute(StepLogger stepLogger, Map<String, Object> context) throws Exception {
        ...
        if (stepLogger != null) {
            stepLogger.writeItem(
                    "activation-create-custom-start",
        ...
        PowerAuthEncryptionHttpHeader header = new PowerAuthEncryptionHttpHeader(model.getApplicationKey(), model.getVersion());
    ...
    public EciesEncryptedRequest createRequest(ActivationContext stepContext) throws Exception {
        CreateActivationStepModel model = stepContext.getModelCreate();
        ...
        requestL1.setIdentityAttributes(stepContext.getModelCreate().getIdentityAttributes());
        requestL1.setCustomAttributes(stepContext.getModelCreate().getCustomAttributes());
    ...
    public ResultStatusObject processResponse(EciesEncryptedResponse encryptedResponseL1,
        ...
        if (context.getStepLogger() != null) {
            context.getStepLogger().writeItem(
                    "activation-create-custom-response-decrypt-inner",
