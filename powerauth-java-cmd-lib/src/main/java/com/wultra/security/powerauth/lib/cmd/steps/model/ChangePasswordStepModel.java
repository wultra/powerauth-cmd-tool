...
/**
 * Model representing step for changing the password for the knowledge factor.
 *
 * @author Roman Strobl, roman.strobl@wultra.com
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ChangePasswordStepModel extends BaseStepModel implements AuthorizationHeaderData, ResultStatusChangeable {
    ...
    /**
     * Original password for the password related key encryption.
     */
    private String password;

    /**
     * New password for the password related key encryption.
     */
    ...
    public Map<String, Object> toMap() {
        ...
        context.put("PASSWORD_NEW", passwordNew);
    ...
    public void fromMap(Map<String, Object> context) {
        ...
        setPasswordNew((String) context.get("PASSWORD_NEW"));
