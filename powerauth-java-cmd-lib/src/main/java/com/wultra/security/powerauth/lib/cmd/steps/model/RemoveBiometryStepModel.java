...
/**
 * Model representing step for setting up biometry.
 *
 * @author Roman Strobl, roman.strobl@wultra.com
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class RemoveBiometryStepModel extends BaseStepModel implements AuthorizationHeaderData, ResultStatusChangeable {
