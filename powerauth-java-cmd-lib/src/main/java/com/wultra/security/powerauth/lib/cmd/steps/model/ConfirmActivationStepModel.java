...
/**
 * Model representing step for confirming an activation.
 *
 * @author Roman Strobl, roman.strobl@wultra.com
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ConfirmActivationStepModel extends BaseStepModel
    ...
    /**
     * Whether the biometric factor should be enabled during activation confirmation.
     */
    ...
    public void fromMap(Map<String, Object> context) {
        ...
        setEnableBiometry((boolean) context.get("ENABLE_BIOMETRY"));
    }
